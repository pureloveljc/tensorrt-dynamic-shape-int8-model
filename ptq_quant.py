...
class ModelData(object):
    MODEL_PATH = "/mnt/stg3/dragon/ljc/DBnetLight_v0.0.0/onnx_db_batch_dynamic.onnx"
    OUTPUT_NAME = "output"
...
def build_int8_engine(onnx_filepath, calib, max_batch_size=32):
    ...
    with trt.Builder(TRT_LOGGER) as builder, builder.create_network(explicit_batch) as network, \
        ...
        profile.set_shape(input_name, min=(1, 3, 256, 256), opt=(1, 3, 800, 800), max=(max_batch_size, 3, 5000, 5000))
        config.add_optimization_profile(profile)

        engine = builder.build_engine(network, config)
        with open('./int8888.engine', "wb") as f:
...
if __name__ == '__main__':
    ...
    # cudaSetDevice(2)
    val_data = '/mnt/stg3/dragon/ljc/ocr_0407/jpg_quant/'
    calibration_cache = "./db_calibration_1.cache"
