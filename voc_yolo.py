...
def VOC2Yolo(class_num, voc_img_path, voc_xml_path, yolo_txt_save_path, yolo_img_save_path=None):
    ...
    for idx, one_xml in enumerate(xmls):
        ...
        print(f"processing: {idx}/{all_xmls}",end='\r')



VOC2Yolo(
    class_num={'icon': 0, 'text': 1},  # 
    voc_img_path='/mnt/stg3/dragon/ljc/code/20220802/det_data/JPEGImages/',
    voc_xml_path='/mnt/stg3/dragon/ljc/code/20220802/det_data/Annotations/', 
    yolo_txt_save_path='/mnt/stg3/dragon/ljc/code/20220802/det_data/txt' 
)
